...
<template v-else>
    <AdminBreadcrumb middle-nav="News" middle-route="admin/news" title="News Create" nav="POST"/>
    ...
    <form class="form" v-on:submit.prevent="handleSubmit">
        ...
        <ImageUploader :max-images="1" for-id="image" :empty-files="emptyData" :image-files="imageData"/>
